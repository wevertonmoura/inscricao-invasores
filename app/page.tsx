...
import { 
  ...
  AlertCircle, ArrowRight, Activity, Zap, Trophy, Mail, MessageCircle, Loader2, Lock, HelpCircle, User, QrCode
} from 'lucide-react';
...
const EVENT_CONFIG = {
  name: "TREINO INVASORES",
  tagline: "Corre com a gente. Evolui no teu ritmo.",
  date: "25/01/2026",
...
// --- COMPONENTE CRONÔMETRO (PROTEGIDO) ---
const Countdown = () => {
...
const FAQSection = () => {
  const faqs = [
    ...
    { p: "Haverá hidratação?", r: "Sim! Teremos pontos de água, mas leve sua garrafinha para garantir." },
  ...
  <section className="py-10 px-4 bg-slate-950">
    <div className="container mx-auto max-w-lg space-y-4">
      <div className="text-center mb-10">
        ...
        <p className="text-slate-400 mt-4">Mais do que correr, nosso objetivo é <span className="text-white font-bold">reunir pessoas</span>.</p>
      </div>
        ...
        <div className="container mx-auto max-w-lg">
          ...
          <div className="relative bg-gradient-to-br from-slate-900 to-slate-800 border-2 border-orange-500/50 rounded-2xl p-6 shadow-2xl shadow-orange-900/20 mb-8 overflow-hidden">
            ...
            <div className="relative z-10 text-center">
              ...
              <div className="my-8">
                <div className="w-20 h-20 bg-green-500 rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg shadow-green-900/50 animate-bounce">
                  <CheckCircle className="w-12 h-12 text-slate-900" />
                </div>
                <p className="text-3xl font-black text-white italic tracking-tighter">VAGA GARANTIDA</p>
                <p className="text-slate-500 text-xs uppercase font-bold tracking-wider mt-1">Evento Gratuito</p>
              </div>
              ...
              <div className="mt-4 pt-4 border-t border-slate-700/50 flex justify-between items-center">
                ...
                <div className="text-right">
                    <span className="text-[10px] text-slate-500 bg-slate-950 px-2 py-1 rounded border border-slate-800">Invasores 2026</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-slate-900 border border-slate-800 p-6 rounded-2xl text-center space-y-3">
            {isFreshRegistration ? (
              <div className="flex flex-col items-center justify-center gap-2 text-slate-300 mb-6 animate-pulse">
                <Loader2 className="w-5 h-5 animate-spin text-green-500" />
                <p className="text-sm font-bold">Abrindo o Grupo VIP...</p>
              </div>
            ) : (
              <p className="text-slate-400 text-sm mb-4">Passos Importantes:</p>
            )}
            
            <a href={WHATSAPP_GROUP_LINK} target="_blank" rel="noopener noreferrer" className="block w-full bg-green-600 hover:bg-green-500 text-white font-black text-lg py-4 rounded-xl shadow-lg transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3">
              <MessageCircle size={24} /> ENTRAR NO GRUPO
            </a>
            
            <a href={shareLink} target="_blank" rel="noopener noreferrer" className="block w-full bg-slate-800 hover:bg-slate-700 text-slate-200 font-bold text-lg py-4 rounded-xl border border-slate-700 transition-all transform hover:scale-[1.02] flex items-center justify-center gap-3">
              <User size={24} className="text-orange-500" /> CHAMAR UM AMIGO
            </a>
            
            <button onClick={handleReset} className="text-slate-500 font-bold underline hover:text-white text-xs mt-6 block mx-auto">
              Nova Inscrição (Limpar memória)
            </button>
          </div>
        </div>
      </div>
      ...
      <div id="inscricao" className="bg-slate-950 px-4 py-20 pb-32">
        <div className="container mx-auto max-w-lg text-center">
          <div className="bg-slate-900 border border-slate-800 p-10 rounded-3xl opacity-90 shadow-2xl">
            <div className="w-20 h-20 bg-slate-800 text-slate-500 rounded-full flex items-center justify-center mx-auto mb-6"><Lock className="w-10 h-10" /></div>
...
export default function LandingPage() {
  ...
  return (
    <main className="min-h-screen bg-slate-950 font-sans selection:bg-orange-500 selection:text-white scroll-smooth">
      ...
      <FAQSection />
      <RegistrationForm />
      <footer className="bg-slate-950 text-slate-600 py-8 text-center text-xs border-t border-slate-900"><p>© 2026 Grupo Invasores. Todos os direitos reservados.</p></footer>
    </main>
  );
}